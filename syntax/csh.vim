...
syn keyword cshStatement cd mv cp eval kill popd shift unhash
syn keyword cshStatement chdir exec login pushd source find grep
syn keyword cshStatement continue exit logout rehash time unsetenv dirs glob nice repeat umask
syn keyword cshStatement wait echo goto nohup mkdir sed rm tar chmod paste echo gunzip awk cat sort uniq vi ls ssh scp date
